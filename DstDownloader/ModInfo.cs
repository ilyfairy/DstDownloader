...
namespace IlyfairyLib.Tools
{
    public class ModInfo
    {
        ...
        /// 创建时间
        /// </summary>
        public DateTime TimeCreated => DateTimeOffset.FromUnixTimeSeconds(details.time_created).LocalDateTime;
        /// <summary>
        /// 更新时间
        /// </summary>
        public DateTime TimeUpdated => DateTimeOffset.FromUnixTimeSeconds(details.time_updated).LocalDateTime;
